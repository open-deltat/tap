...
// when an allowlist is set. Scoped to /embed only, since a global frame-ancestors would intersect
// with this and silently neutralize the allowlist, and the rest of the app should not be framable.
