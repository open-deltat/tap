...
import { SeatMap } from "@open-deltat/examples/components/seat-map";
import { useWebSocket, wsUrl, type StreamStatus } from "@open-deltat/examples/hooks/use-websocket";
import { buildSections, allSeatIds } from "@open-deltat/examples/lib/seat-sections";
