...
export function OverviewTopic() {
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <p className="mt-1 text-sm text-emerald-300/90">A small database that does one job: keep bookings from clashing.</p>
      ...
      <div className="mt-5 space-y-3 text-[13.5px] leading-relaxed text-zinc-400">
        ...
        <p>
          ...
          clash when their stretches cover the same moment. That is the entire model.
        </p>
      </div>
      ...
      <div className="mt-5 space-y-3 text-[13.5px] leading-relaxed text-zinc-400">
        <p>
          ...
          so they clash. The dinner is on its own, so it is fine. Checking a booking is really just
      ...
      <p className="mt-5 text-[11px] text-zinc-500">
        Next, the data model: how a booking, a closed day, and free time all live on that one line.
      </p>
    </div>
  );
}
