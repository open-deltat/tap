    ...
    <div className="mx-auto max-w-2xl">
      ...
      <div className="mt-5">
        ...
        <LabeledTimeline
          ...
          rows={[
            {
              boxes: [
                { start: 8, end: 20, color: "emerald", text: "Mon 1" },
                { start: 32, end: 44, color: "emerald", text: "Mon 2" },
                { start: 56, end: 68, color: "emerald", text: "Mon 3" },
                { start: 80, end: 92, color: "emerald", text: "Mon 4" },
              ],
            },
          ]}
        />
      ...
      <div className="mt-5 space-y-3 text-[13.5px] leading-relaxed text-zinc-400">
        ...
        <p>
          ...
          real rules and stores them for you. Every demo here sets up its availability this way.
        </p>
        <p>
