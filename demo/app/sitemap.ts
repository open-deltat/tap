...
// Indexable surface only: the landing, every docs page (derived from the docs nav tree, so the
// two can never drift), and every enabled demo. /embed, /embed-test, and /calendar are left out
